...
- Playlist: arrows, Page Up/Down, Home/End select; Enter plays; Delete removes; Alt-Up/Down reorders.
- Player: Left/Right seeks ±10 seconds and Down/Up seeks ±60 seconds.
