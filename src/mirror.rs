...
fn print_auto_tune_report(base: &MirrorOptions, trials: &[AutoTuneTrial]) {
    ...
    println!(
        "\nUse: castscreen cast-desktop --host {} --cast-port {} --target-delay-ms {} --fps {} --width {} --height {} --bitrate {}{}",
        base.cast_host,
        base.cast_port,
        winner.result.recommendations.balanced_ms,
...
fn negotiate_cast_streaming(
    ...
    thread::Builder::new()
        .name("castscreen-mirror-control".into())
        .spawn(move || {
...
impl FeedbackThread {
    fn start(
        ...
        let thread = thread::Builder::new()
            .name("castscreen-mirror-rtcp".into())
            .spawn(move || {
...
impl EncoderWorker {
    fn start(
        ...
        let thread = thread::Builder::new()
            .name("castscreen-mirror-encoder".into())
            .spawn(move || {
                loop {
                    let frame = {
...
impl SyntheticFrameSource {
    fn start(
        ...
        let thread = thread::Builder::new()
            .name("castscreen-synthetic-frames".into())
            .spawn(move || {
