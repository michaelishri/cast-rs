...
impl VideoInfoRaw {
    pub fn new() -> Self {
        // The flags field and modifier signedness changed in PipeWire 0.3.65.
        // Zero initialization is valid for this numeric C struct and lets this
        // crate compile against both the Ubuntu 22.04 and current headers.
